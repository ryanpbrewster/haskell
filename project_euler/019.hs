...
-- From Wikipedia
dayOfWeek year month date = let t = [0,3,2,5,0,3,5,1,4,6,2,4]
...
problem019 = count 0 firstDaysOfEachMonth
             where firstDaysOfEachMonth = [ dayOfWeek year month 1 | year <- [1901..2000], month <- [1..12] ]

main = print ans where ans = problem019
